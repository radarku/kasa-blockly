(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('dgram'), require('events')) :
  typeof define === 'function' && define.amd ? define(['dgram', 'events'], factory) :
  (global = global || self, global.tplinkLightbulb = factory(global.dgram, global.events));
})(this, (function (dgram, EventEmitter) {
  ...
  class TPLSmartDevice {
    ...
    static scan(filter, broadcast = '255.255.255.255') {
      ...
      const client = dgram__default["default"].createSocket({
        type: 'udp4',
        reuseAddr: true
      });
...
//# sourceMappingURL=tplink-lightbulb.umd.js.map
